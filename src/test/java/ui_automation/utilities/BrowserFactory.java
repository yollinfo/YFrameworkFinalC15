...
public class BrowserFactory {
            ...
            if (System.getProperty("browser") == null) {
                ...
                switch (System.getProperty("browser")) {
                    ...
                    case "chromeRemote":
                        ...
                        try {
                            driver = new RemoteWebDriver(new URL("http://54.80.58.108:4444/wd/hub"), chrOptions);
                    ...
                    case "firefoxRemote":
                        ...
                        try {
                            driver = new RemoteWebDriver(new URL("http://54.80.58.108:4444/wd/hub"), firOptions);
                        } catch (MalformedURLException e) {
                            e.printStackTrace();
                        }
                        break;
    ...
    public static WebDriver createInstance(String browser) {
        WebDriver driver = null;
        if (browser.equals("chromeRemote")) {
            HashMap<String, Object> chromePrefs = new HashMap<String, Object>();
            chromePrefs.put("download.default_directory", System.getProperty("user.dir") + "\\src\\test\\resources\\testData\\Downloads");
            ChromeOptions chrOptions = new ChromeOptions();
            chrOptions.addArguments("--ignore-ssl-errors=yes");
